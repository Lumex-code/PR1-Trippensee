...
OBJECT objs[] = {
   ...
   {"the exit of the mine"					, "exi_mine"			, mine		,NULL	,NULL	,cave	},
   {"the entrance of a mine"				, "ent_mine"			, cave		,NULL	,NULL	,mine	},
   {"the exit of the cave into an forest"	, "exi_cave"			, cave		,NULL	,NULL	,forest	},
   ...
   {"a door to the rest of the house"		, "exi_bedroom"			, bedroom	,NULL	,NULL	,hut	},
   ...
   {"a small golden key"	, "key"			, chest		, 0		,	5	,NULL},
